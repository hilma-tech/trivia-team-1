...
CREATE TABLE `quiz` (
  ...
  CONSTRAINT `FK_155a5e61914fd82daef9da16dfa` FOREIGN KEY (`creatorId`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `quiz` VALUES (1,'hi','bye','asdf.com',2),(2,'dogs','black dogs','dogs.com',2);
...
INSERT INTO `score` VALUES (1,'10','boaz','2023-03-05 10:39:05.299383',1),(2,'8','boaz','2023-03-05 10:39:05.299383',1),(3,'15','dvir','2023-03-05 10:39:05.299383',1),(4,'20','noam','2023-03-05 10:39:05.299383',1);
...
-- Dump completed on 2023-03-05 14:28:06
