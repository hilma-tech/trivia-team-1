  ...
  return isLargeScreen ? (
    <div className="comp-children-container score-card-container">
      <div className="score-card">
        ...
        <Typography variant="h6" className="h3 hide-mobile" component="div">
          {quizData.title}
        </Typography>
        <TableContainer>
          <Table>
            ...
            <TableBody>
              {quizData.scores.map((score, i) => (
                <HighScore key={score.id} score={score} index={i} />
              ))}
            </TableBody>
          </Table>
        </TableContainer>
    ...
    <PhonePageWithNav
      className="comp-children-container phone-score-card-container"
      title="החידונים שלי"
      type="return"
    >
      <div className="score-card">
